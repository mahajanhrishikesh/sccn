...
class _MyAppState extends State<MyApp> {
  ...
  List<Widget> _widgetOptions = <Widget>[
    ...
    Container( //Code for dashboard begins here
    ...
    Container( //Code for graphs begins here
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [
          const Color(0xFF3F51B5),
          const Color(0xFF2196F3),
    ...
    Container(  //Code for legend begins here
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [
          const Color(0xFF3F51B5),
          const Color(0xFF2196F3),
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: new Image.asset('assets/sccn_logo.png', fit: BoxFit.cover, color: Colors.white,),
        ),
